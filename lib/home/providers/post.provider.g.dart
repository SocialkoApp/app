...
String _$postHash() => r'495e3e898a09b5f70495ae35d7a00c8aeb49845c';
...
typedef PostRef = AutoDisposeFutureProviderRef<PostModel>;

/// See also [post].
final postProvider = PostFamily();
...
class PostFamily extends Family<AsyncValue<PostModel>> {
  ...
  @override
  AutoDisposeFutureProvider<PostModel> getProviderOverride(
